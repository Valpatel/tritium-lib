...
"""Tests for tritium_lib.geo — geo-reference singleton and coordinate transforms.

Also covers integration with the sim-engine and tracking targets, which read
the geo-reference singleton when serializing real-world lat/lng.
"""
...
def reset_reference():
    ...
    from tritium_lib.geo import reset
    reset()
    yield
    reset()
