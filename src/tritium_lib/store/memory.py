...
"""Persistent long-term memory — JSON key-value store with recall.

Stores spatial observations, event timelines, room understanding,
person profiles, facts, and self-model data. All data is saved to
a JSON file and reloaded on startup.
"""
...
class Memory:
    ...
    def __init__(self, path: str | None = None):
        if path is None:
            path = os.path.join(os.getcwd(), "data", "memory.json")
        self.path = path
