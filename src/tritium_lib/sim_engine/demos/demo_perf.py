...
"""Performance benchmark for the sim_engine.ai simulation engine.

Run: python3 -m tritium_lib.sim_engine.ai.demos.demo_perf
...
from tritium_lib.sim_engine.ai.ambient_np import AmbientSimulatorNP, PEDESTRIAN, VEHICLE
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Tritium sim_engine.ai performance benchmark")
