...
try:
    from tritium_lib.sim_engine.behavior._degradation_compat import can_fire_degraded
except ImportError:
    def can_fire_degraded(target) -> bool:  # type: ignore[misc]
        """Fallback: always allow fire if degradation module unavailable."""
        return True
