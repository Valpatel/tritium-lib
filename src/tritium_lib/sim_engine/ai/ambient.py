...
Usage::
    ...
    from tritium_lib.sim_engine.ai.ambient import AmbientSimulator, ActivityProfile
...
from tritium_lib.sim_engine.ai.steering import Vec2, distance, normalize, magnitude
