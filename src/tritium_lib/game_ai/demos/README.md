# Game AI Visual Demos

Standalone scripts that prove the simulation works visually and measure performance.
Each demo imports only from `tritium_lib.game_ai` -- no tritium-sc dependencies.
...
python3 -m tritium_lib.game_ai.demos.demo_steering --headless --duration 10
```
...
python3 -m tritium_lib.game_ai.demos.demo_city --headless --duration 20
```
...
python3 -m tritium_lib.game_ai.demos.demo_perf --duration 5
```
...
python3 -m tritium_lib.game_ai.demos.demo_rf --headless --duration 15
```
